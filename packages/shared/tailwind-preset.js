 ...
 *
 * Both consoles extend this preset so the design tokens, radii, shadows and motion
 * curves cannot drift between the two applications. Each app supplies its own `content`.
 */
