...
import { api, type Overview, useAuth, useToasts, useUi, cn, Badge, StatusDot, Tooltip } from '@finops/shared'
...
const NAV = [
  ...
  { to: '/models', label: 'Models', icon: SparklesIcon, permission: 'service:read' },
