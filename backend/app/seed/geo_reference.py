...
ALPHA2_TO_ALPHA3: dict[str, str] = {
    "IN": "IND", "AE": "ARE", "SG": "SGP", "GB": "GBR", "US": "USA", "IR": "IRN",
    "RU": "RUS", "CN": "CHN", "HK": "HKG", "DE": "DEU", "FR": "FRA", "CH": "CHE",
    "NL": "NLD", "AU": "AUS", "JP": "JPN", "CA": "CAN", "BR": "BRA", "ZA": "ZAF",
    "NG": "NGA", "KE": "KEN", "SA": "SAU", "QA": "QAT", "MY": "MYS", "ID": "IDN",
    "LK": "LKA", "BD": "BGD", "PK": "PAK", "KP": "PRK", "SY": "SYR", "AF": "AFG",
    "MM": "MMR", "YE": "YEM", "SS": "SSD", "CU": "CUB", "VE": "VEN",
}
