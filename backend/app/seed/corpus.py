...
KNOWLEDGE_SOURCES: list[dict[str, Any]] = [
    {"key": "banking_policies", "name": "Retail Banking Policies", "connector": "upload",
     "description": "Product terms, servicing policies and customer-facing procedures.",
     "status": "connected", "classification": "internal"},
    {"key": "compliance_policies", "name": "Compliance & Financial Crime Policies",
     "connector": "upload",
     "description": "KYC, AML, sanctions and regulatory reporting policy set.",
     "status": "connected", "classification": "confidential"},
    {"key": "aml_typologies", "name": "AML Typology Library", "connector": "upload",
     "description": "FATF and internal typology descriptions used by investigators.",
     "status": "connected", "classification": "confidential"},
    {"key": "engineering_docs", "name": "Engineering Architecture Docs", "connector": "confluence",
     "description": "Platform architecture, service contracts and design decisions.",
     "status": "not_configured", "classification": "internal",
     "config": {"space_key": "ENG", "limit": 100}},
    {"key": "runbooks", "name": "Operational Runbooks", "connector": "upload",
     "description": "Incident response, on-call and disaster-recovery runbooks.",
     "status": "connected", "classification": "internal"},
    {"key": "meeting_notes", "name": "Meeting Notes", "connector": "sharepoint",
     "description": "Governance forum and steering committee minutes.",
     "status": "not_configured", "classification": "confidential"},
    {"key": "product_catalogue", "name": "Product Catalogue", "connector": "upload",
     "description": "Deposit, lending, card and wealth product specifications.",
     "status": "connected", "classification": "internal"},
    {"key": "research_library", "name": "Investment Research Library", "connector": "upload",
     "description": "House view, methodology notes and published research.",
     "status": "connected", "classification": "internal"},
    {"key": "jira_delivery", "name": "Jira Delivery Board", "connector": "jira",
     "description": "Delivery backlog and incident tickets.",
     "status": "not_configured", "classification": "internal",
     "config": {"jql": "project = PLAT ORDER BY updated DESC", "limit": 100}},
    {"key": "slack_platform", "name": "Slack #platform-engineering", "connector": "slack",
     "description": "Engineering channel history.", "status": "not_configured",
     "classification": "internal", "config": {"channel_id": "", "channel_name": "platform-engineering"}},
]
