...
INTERNAL_WATCHLIST: list[dict[str, Any]] = [
    ...
    {
        "list_name": "INTERNAL",
        "full_name": "Helios Metals Trading Ltd",
        "entry_type": "entity",
        "aliases": ["Helios Metals"],
        "nationality": "GB",
    ...
    {
        "list_name": "PEP",
        "full_name": "Rajesh Kumar Venkatesan",
        "is_pep": True,
        "aliases": ["R. K. Venkatesan"],
    ...
    {
        "list_name": "PEP",
        "full_name": "Elena Marisol Vargas",
        "is_pep": True,
        "aliases": ["E. M. Vargas"],
    ...
    {
        "list_name": "PEP",
        "full_name": "Suresh Nathan Iyer",
        "is_pep": True,
        "date_of_birth": "1966-01-23",
        "nationality": "IN",
    ...
    {
        "list_name": "PEP",
        "full_name": "Marcus Aurelius Brandt",
        "is_pep": True,
